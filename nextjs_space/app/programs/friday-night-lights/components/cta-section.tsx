      ...
      <div className="container mx-auto px-4 max-w-4xl text-center">
        <div className="bg-white border-2 border-tbf-gold rounded-2xl p-12 shadow-xl">
          <h2 className="text-4xl md:text-5xl font-bold text-black mb-6 font-russo-one">
            Ready to <span className="text-tbf-gold">Hoop?</span>
          </h2>
          <p className="text-lg text-gray-600 mb-4 max-w-2xl mx-auto">
            Friday nights at The Basketball Factory are the best way to end the week. Bring your game &mdash; we&apos;ll bring the competition.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            >
              <Link href="/contact-us">Register Now</Link>
            </Button>
            <Button
              asChild
              size="lg"
