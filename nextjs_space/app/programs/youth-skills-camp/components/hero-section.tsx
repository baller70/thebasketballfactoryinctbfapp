        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h1 className="text-5xl md:text-6xl font-bold text-white mb-6 font-russo-one">
              Youth Skills & Development Training Camp
            </h1>
            
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              Focused skill development camp for young athletes at The Basketball Factory in Sparta, NJ. Perfect for improving fundamentals and building confidence on the court.
            </p>
          ...
          <div className="relative h-[400px] lg:h-[500px] rounded-2xl overflow-hidden">
            <Image
              ...
              alt="Youth Skills & Development Training Camp"
              fill
