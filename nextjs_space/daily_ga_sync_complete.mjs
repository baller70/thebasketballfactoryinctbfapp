/**
 * Complete Daily Google Analytics Sync
...
Message: No new data available from Google Search Console
========================================
`;
      appendFileSync(LOG_FILE, logEntry);
...
Timestamp: ${timestamp}
Status: SUCCESS
Message: GA sync completed successfully
Records Created: ${results.recordsCreated}
Records Updated: ${results.recordsUpdated}
Keywords Synced: ${results.totalKeywords}
========================================
`;
    appendFileSync(LOG_FILE, logEntry);
