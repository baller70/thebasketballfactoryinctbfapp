...
export default function YouthWinterDetails() {
  return (
        ...
        <div className="text-center mb-12">
          ...
          >
            ...
            <p className="text-white/60 text-sm max-w-2xl mx-auto">
              Everything you need to know about the Youth Winter Open Gym program
            </p>
          </motion.div>
        </div>
              ...
              <div className="bg-tbf-gold/10 rounded-lg p-4 mb-4">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <div className="text-white font-bold text-lg">11:30 AM - 1:00 PM</div>
                  </div>
