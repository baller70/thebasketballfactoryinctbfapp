...
export default function YouthWinterOverview() {
  return (
        ...
        <div className="text-center mb-12">
          ...
          >
            ...
            <p className="text-white/70 text-base max-w-3xl mx-auto leading-relaxed">
              Stay active during winter with supervised open gym sessions. Designed for youth athletes to practice skills in a fun, supportive environment.
            </p>
          </motion.div>
        </div>
