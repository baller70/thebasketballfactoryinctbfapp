    ...
    <div className="space-y-8">
      <div className="text-center">
        ...
        <p className="text-white/80 max-w-2xl mx-auto">
          Sign up for a single session drop-in. All sessions are held on <strong className="text-[#C8B273]">Tuesdays</strong> at our Sparta, NJ facility. Boys &amp; girls welcome.
        </p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
        {/* Full Program - SOLD OUT / Crossed Out */}
        ...
        >
          ...
          <ul className="space-y-2">
            {[
              '1 training session — pay as you go',
              'Tuesdays: 8:00 PM - 9:30 PM',
              'High school boys & girls (9th-12th grade)',
              'Professional coaching with Kevin Houston',
              'All equipment provided',
              'Great for staying sharp during the season',
            ].map((feature, index) => (
      ...
      {/* Schedule Info */}
      <div className="max-w-4xl mx-auto bg-[#C8B273]/10 border border-[#C8B273]/30 rounded-lg p-6">
        <h4 className="text-white font-bold font-audiowide mb-3 text-center">TUESDAY SESSION SCHEDULE</h4>
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-center text-sm">
          <div className="bg-black/30 rounded-lg p-3 border border-white/10">
            <p className="text-[#C8B273] font-bold">Grades 2nd - 6th</p>
            <p className="text-white">5:00 PM - 6:30 PM</p>
            <p className="text-white/60 text-xs">Boys &amp; Girls</p>
          </div>
          <div className="bg-black/30 rounded-lg p-3 border border-white/10">
            <p className="text-[#C8B273] font-bold">Grades 7th - 8th</p>
            <p className="text-white">6:30 PM - 8:00 PM</p>
            <p className="text-white/60 text-xs">Boys &amp; Girls</p>
          </div>
          <div className="bg-black/30 rounded-lg p-3 border border-[#C8B273]/30">
            <p className="text-[#C8B273] font-bold">Grades 9th - 12th</p>
            <p className="text-white">8:00 PM - 9:30 PM</p>
            <p className="text-white/60 text-xs">Boys &amp; Girls</p>
          </div>
        </div>
      </div>
      ...
      <div className="flex justify-center pt-6">
        <Button
          ...
          className="bg-tbf-gold hover:bg-tbf-gold/90 text-black font-bold px-12 py-6 text-lg rounded-none shadow-xl disabled:opacity-50"
        >
