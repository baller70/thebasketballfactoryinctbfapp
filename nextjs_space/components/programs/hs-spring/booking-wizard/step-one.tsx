    ...
    <div className="space-y-8">
            ...
            >
              {pkg.popular && (
                <div className="absolute -top-3 left-1/2 transform -translate-x-1/2">
                  <span className="bg-tbf-gold text-black text-xs font-bold px-4 py-1 rounded-full shadow-lg">
                    BEST VALUE
                  </span>
                </div>
              )}
      ...
      <div className="flex justify-center pt-6">
        <Button
          ...
          className="bg-tbf-gold hover:bg-tbf-gold/90 text-black font-bold px-12 py-6 text-lg rounded-none shadow-xl"
        >
