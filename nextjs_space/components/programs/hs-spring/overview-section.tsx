...
const features = [
  ...
  },
  {
    ...
    description: 'Prepare to excel in AAU tournaments with increased confidence and mental toughness developed through competitive training.'
  },
  {
    icon: Users,
    title: 'Expert Coaching',
    description: 'Learn from experienced coaches who understand what it takes to compete at the highest level and succeed in tournament play.'
  },
  {
    icon: Award,
    title: 'Competitive Edge',
    description: 'Get ahead of the competition and be ready to dominate the AAU season with advanced techniques and game-situation training.'
  }
]

export default function HSSpringOverview() {
  return (
        ...
        <div className="text-center mb-12">
          ...
          >
            ...
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4 font-audiowide">
              WHY CHOOSE OUR <span className="text-tbf-gold">SPRING CIRCUIT?</span>
            </h2>
            <p className="text-white/70 text-base max-w-3xl mx-auto leading-relaxed">
              Prepare for AAU season with elite training. Designed specifically for high school athletes preparing for tournament basketball.
            </p>
          </motion.div>
        </div>
