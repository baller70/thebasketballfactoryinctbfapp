...
export default function HSSpringDetails() {
  return (
        ...
        <div className="text-center mb-12">
          ...
          >
            ...
            <p className="text-white/60 text-sm max-w-2xl mx-auto">
              Everything you need to know about the High School Spring Circuit program
            </p>
          </motion.div>
        </div>
        ...
        >
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div className="text-center">
              ...
              <div className="text-white font-bold text-lg">Grades 9th - 12th</div>
            </div>
            <div className="text-center">
              ...
              <div className="bg-tbf-gold/10 rounded-lg p-4 mb-4">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <div className="text-white font-bold text-lg">8:00 PM - 9:30 PM</div>
                  </div>
