...
const programDates = [
  { date: '2026-04-08', day: 'Wednesday', week: 'Week 1' },
  { date: '2026-04-15', day: 'Wednesday', week: 'Week 2' },
  { date: '2026-04-22', day: 'Wednesday', week: 'Week 3' },
  { date: '2026-04-29', day: 'Wednesday', week: 'Week 4' },
  { date: '2026-05-06', day: 'Wednesday', week: 'Week 5' },
  { date: '2026-05-13', day: 'Wednesday', week: 'Week 6' },
  { date: '2026-05-20', day: 'Wednesday', week: 'Week 7' },
  { date: '2026-05-27', day: 'Wednesday', week: 'Week 8' },
]
        ...
        {isFullProgram && (
          <div className="bg-[#C8B273]/10 border border-[#C8B273]/30 rounded-lg p-6 mb-6">
            ...
            <p className="text-white/70 text-sm">
              Sessions run every Wednesday from 4:00 PM - 7:00 PM. All ages, boys & girls.
            </p>
          </div>
        )}
                      ...
                      >
                        <div className="flex items-center justify-between">
                          <div>
                            ...
                            <p className="text-[#C8B273] text-sm font-semibold mt-1">4:00 PM - 7:00 PM</p>
                          </div>
                          {isSelected && (
