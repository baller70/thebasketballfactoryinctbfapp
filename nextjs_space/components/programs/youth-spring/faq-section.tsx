...
const faqs = [
  {
    ...
    answer: 'This program is designed specifically for young athletes in grades 1-5 (ages 6-11). We welcome players of all skill levels - whether you\'re just starting out, looking to improve your skills, or aiming to take your game to the next level. Our expert coaches adapt the training to meet each athlete where they are and push them to reach their full potential.'
  },
  {
...
export default function YouthSpringFAQ() {
        ...
        <div className="text-center mb-16">
          ...
          >
            ...
            <p className="text-white/80 text-lg max-w-3xl mx-auto leading-relaxed">
              Got questions? We've got answers. Here's everything parents need to know about our Youth Spring Open Gym program.
            </p>
          </motion.div>
        </div>
