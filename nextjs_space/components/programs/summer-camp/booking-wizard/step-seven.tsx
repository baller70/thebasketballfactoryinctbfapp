...
export default function StepSeven({ bookingData }: StepSevenProps) {
  ...
  const handleShareProgram = () => {
    if (navigator.share) {
      navigator.share({
        title: 'TBF Weekly Summer Basketball Camp - The Basketball Factory',
        text: 'I just registered for The Basketball Factory\'s TBF Weekly Summer Basketball Camp program!',
    ...
    <div className="space-y-8">
      ...
      <div className="text-center">
        ...
        <p className="!text-white bg-transparent/80 text-lg max-w-2xl mx-auto">
          Congratulations! {bookingData.playerName} is officially registered for the TBF Weekly Summer Basketball Camp program. 
