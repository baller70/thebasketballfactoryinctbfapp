...
export default function YouthFallOpenGymHero() {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-[320px] pb-32">
      ...
      <div className="absolute inset-0 z-0">
        <Image
          src="/youth-fall-basketball-open-gym-hero-image.png"
          alt="Youth Fall Open Gym"
          fill
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          <p className="text-xl sm:text-2xl !text-white bg-transparent/90 mb-4 max-w-3xl mx-auto font-medium">
            Flexible Practice Time & Supervised Play
          </p>
          
          <p className="text-lg !text-white bg-transparent/70 mb-12 max-w-2xl mx-auto leading-relaxed">
            Join our Open Gym sessions at The Basketball Factory in Sparta, New Jersey. Enjoy flexible practice time, hone your skills, and play with other local athletes in a competitive yet friendly environment!
          </p>

          {/* Key Stats */}
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-3xl mx-auto mb-12">
            <div className="bg-black/50 backdrop-blur-sm border border-tbf-gold/30 rounded-lg p-6">
              <div className="text-3xl font-bold text-tbf-gold mb-2 font-russo-one">7-18</div>
              <div className="!text-white bg-transparent/80 text-sm">Ages</div>
            </div>
            <div className="bg-black/50 backdrop-blur-sm border border-tbf-gold/30 rounded-lg p-6">
              <div className="text-3xl font-bold text-tbf-gold mb-2 font-russo-one">4 Hrs</div>
              <div className="!text-white bg-transparent/80 text-sm">Per Session</div>
            </div>
            <div className="bg-black/50 backdrop-blur-sm border border-tbf-gold/30 rounded-lg p-6">
              <div className="text-3xl font-bold text-tbf-gold mb-2 font-russo-one">MON</div>
              <div className="!text-white bg-transparent/80 text-sm">Weekly</div>
            </div>
          </div>
