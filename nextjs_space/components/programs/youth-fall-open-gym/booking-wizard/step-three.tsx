...
// Actual program dates for Youth Fall Open Gym - Remaining Mondays in November 2025
const programDates = [
  { date: '2025-11-17', day: 'Monday', week: 'Week 1' },
  { date: '2025-11-24', day: 'Monday', week: 'Week 2' },
].filter(session => {
    ...
    <div className="space-y-8">
      <div className="text-center">
        ...
        <p className="text-white/80 max-w-2xl mx-auto">
          {isFullProgram 
            ? 'You\'re registered for both remaining sessions. Review the complete schedule below.'
          ...
          <div className="bg-[#C8B273]/10 border border-[#C8B273]/30 rounded-lg p-6 mb-6">
            <div className="flex items-center gap-2 mb-4">
              ...
              <p className="text-white font-semibold">
                Both remaining sessions are included in your Full Program registration
              </p>
            </div>
            <p className="text-white/70 text-sm">
              Sessions run every Monday from 4:30 PM - 8:30 PM
            </p>
          </div>
        )}
                      ...
                      >
                        <div className="flex items-center justify-between">
                          <div>
                            ...
                            <p className="text-[#C8B273] text-sm font-semibold mt-1">4:30 PM - 8:30 PM</p>
                          </div>
                          {isSelected && (
