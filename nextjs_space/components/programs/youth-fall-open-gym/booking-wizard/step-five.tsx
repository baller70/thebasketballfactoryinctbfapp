...
export default function StepFive({ bookingData, updateBookingData, nextStep, prevStep }: StepFiveProps) {
  const handleContinue = () => {
    console.log('=== Step Five Continue Button Clicked ===')
    console.log('bookingData.skillLevel:', bookingData.skillLevel)
    console.log('bookingData.emergencyContact:', bookingData.emergencyContact)
    console.log('bookingData.emergencyPhone:', bookingData.emergencyPhone)
    console.log('isFormValid:', bookingData.skillLevel && bookingData.emergencyContact && bookingData.emergencyPhone)
    ...
    if (
      ...
      if (!bookingData.skillLevel) console.log('  - Missing: skillLevel')
      if (!bookingData.emergencyContact) console.log('  - Missing: emergencyContact')
      if (!bookingData.emergencyPhone) console.log('  - Missing: emergencyPhone')
    }
  }
