...
export default function StepSeven({ bookingData }: StepSevenProps) {
  ...
  const handleShareProgram = () => {
    if (navigator.share) {
      navigator.share({
        title: 'Youth Skills High School Fall Workouts Development Training Camp - The Basketball Factory',
        text: 'I just registered for The Basketball Factory\'s Youth Skills High School Fall Workouts Development Training Camp program!',
    ...
    <div className="space-y-8">
      ...
      <div className="text-center">
        ...
        <p className="!text-white bg-transparent/80 text-lg max-w-2xl mx-auto">
          Congratulations! {bookingData.playerName} is officially registered for the Youth Skills High School Fall Workouts Development Training Camp program. 
