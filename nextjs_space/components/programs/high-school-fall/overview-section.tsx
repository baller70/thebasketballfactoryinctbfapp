...
export default function HSFallOverview() {
  return (
        ...
        <div className="text-center mb-12">
          ...
          >
            ...
            <p className="text-white/70 text-base max-w-3xl mx-auto leading-relaxed">
              Get a head start on the winter basketball season. Designed specifically for high school players gearing up for school team tryouts.
            </p>
          </motion.div>
        </div>
