...
export default function FreeYouthHero() {
  ...
  return (
    <section className="relative min-h-[85vh] flex items-center justify-center overflow-hidden bg-black pt-[320px]">
      ...
      <div className="absolute inset-0 z-0">
        <Image
          src="/little-ballers-free-basketball-clinic-hero.jpg"
          alt="Little Ballers Basketball Training"
          fill
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          <span className="!text-white bg-transparent block mb-2">Give Your Child</span>
        ...
        >
          ...
          <span className="!text-white bg-transparent font-semibold">Perfect for Ages 7-10</span>
          <Star className="w-5 h-5 text-[#C8B273]" />
        </motion.div>
        ...
        >
          Sparta, NJ Parents: Join our FREE 1-hour basketball session designed specifically for elementary-aged kids. 
          Expert coaching, fun drills, and confidence-building skills – all at{' '}
          <span className="text-[#C8B273] font-bold">ZERO cost</span> to your family!
        </motion.p>
