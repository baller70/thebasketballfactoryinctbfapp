...
const programDates = [
  ...
  { date: '2025-10-19', day: 'Sunday', week: 'Week 3' },
  { date: '2025-10-26', day: 'Sunday', week: 'Week 4' },
  { date: '2025-11-02', day: 'Sunday', week: 'Week 5' },
  { date: '2025-11-09', day: 'Sunday', week: 'Week 6' },
  { date: '2025-11-16', day: 'Sunday', week: 'Week 7' },
].filter(session => {
    ...
    <div className="space-y-8">
      <div className="text-center">
        ...
        <p className="text-white/80 max-w-2xl mx-auto">
          {isFullProgram 
            ? 'You\'re registered for all 7 sessions. Review the complete schedule below.'
          ...
          <div className="bg-[#C8B273]/10 border border-[#C8B273]/30 rounded-lg p-6 mb-6">
            <div className="flex items-center gap-2 mb-4">
              ...
              <p className="text-white font-semibold">
                All 7 sessions are included in your Full Program registration
              </p>
            </div>
            <p className="text-white/70 text-sm">
              Sessions run every Sunday from 11:30 AM - 1:00 PM
            </p>
          </div>
        )}
                      ...
                      >
                        <div className="flex items-center justify-between">
                          <div>
                            ...
                            <p className="text-[#C8B273] text-sm font-semibold mt-1">11:30 AM - 1:00 PM</p>
                          </div>
                          {isSelected && (
      ...
      <div className="flex justify-center gap-4 pt-6">
        <Button
          onClick={prevStep}
          variant="outline"
          className="border-2 border-[#C8B273] !text-white hover:bg-[#C8B273]/20 bg-transparent px-8 py-6 text-lg rounded-none font-semibold"
        >
          Back
        </Button>
        <Button
