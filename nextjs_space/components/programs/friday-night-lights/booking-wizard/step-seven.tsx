...
export default function StepSeven({ bookingData }: StepSevenProps) {
  ...
  const handleShareProgram = () => {
    if (navigator.share) {
      navigator.share({
        title: 'Friday Night Lights Summer Open Gym - The Basketball Factory',
        text: 'I just registered for The Basketball Factory\'s Friday Night Lights Summer Open Gym program!',
    ...
    <div className="space-y-8">
      ...
      <div className="text-center">
        ...
        <p className="text-white/80 text-lg max-w-2xl mx-auto">
          Congratulations! {bookingData.playerName} is officially registered for the Friday Night Lights Summer Open Gym program. 
