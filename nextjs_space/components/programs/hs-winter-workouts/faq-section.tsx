...
const faqs = [
  {
    ...
    answer: 'This program is designed specifically for high school athletes in grades 9-12 (ages 14-18). We welcome players of all skill levels - whether you\'re preparing for your first tryout, looking to make varsity, or aiming to take your game to the next level. Our expert coaches adapt the training to meet each athlete where they are and push them to reach their full potential.'
  },
  {
...
export default function HSWinterFAQ() {
        ...
        <div className="text-center mb-16">
          ...
          >
            ...
            <p className="text-white/80 text-lg max-w-3xl mx-auto leading-relaxed">
              Got questions? We've got answers. Here's everything parents need to know about our High School Winter Workouts program.
            </p>
          </motion.div>
        </div>
