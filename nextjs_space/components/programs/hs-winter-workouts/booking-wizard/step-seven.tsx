  ...
  const handleShareProgram = () => {
    if (navigator.share) {
      navigator.share({
        ...
        text: 'I just registered for The Basketball Factory\'s High School Winter Workouts program!',
    ...
    <div className="space-y-8">
      ...
      <div className="text-center">
        ...
        <p className="text-white/80 text-lg max-w-2xl mx-auto">
          Congratulations! {bookingData.playerName} is officially registered for the High School Winter Workouts program. 
