            ...
            >
                ...
                <div className="bg-tbf-gold/10 rounded-lg p-4 mb-4">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <div className="text-white font-bold text-lg">11:30 AM - 1:00 PM (90 Minutes)</div>
                    </div>
                ...
                <div className="bg-tbf-gold/10 rounded-lg p-4 mb-4">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <div className="text-white font-bold text-lg">8:00 PM - 9:00 PM (60 Minutes)</div>
                    </div>
                    <Clock className="w-8 h-8 text-tbf-gold/40" />
                  </div>
                </div>
              ...
              <div className="space-y-2 text-sm">
                <div className="flex items-start gap-2 text-white/70">
                  ...
                  <span>Choose either Sunday OR Monday track during registration</span>
                </div>
                <div className="flex items-start gap-2 text-white/70">
                  <span className="text-tbf-gold mt-0.5">•</span>
