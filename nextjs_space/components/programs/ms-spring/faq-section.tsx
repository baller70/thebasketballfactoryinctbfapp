...
export default function MSSpringFAQ() {
        ...
        <div className="text-center mb-16">
          ...
          >
            ...
            <p className="text-white/80 text-lg max-w-3xl mx-auto leading-relaxed">
              Got questions? We've got answers. Here's everything parents need to know about our Middle School Spring Circuit program.
            </p>
          </motion.div>
        </div>
