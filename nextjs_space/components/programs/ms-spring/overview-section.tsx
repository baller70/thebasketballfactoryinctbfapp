...
const features = [
  ...
  },
  {
    ...
    description: 'Build confidence and mental toughness during the spring season with competitive training designed for middle school athletes.'
  },
  {
    icon: Users,
    title: 'Expert Coaching',
    description: 'Learn from experienced coaches who understand how to develop young players and build a strong basketball foundation.'
  },
  {
    icon: Award,
    title: 'Competitive Edge',
    description: 'Develop your skills and be ready for the next level with advanced techniques and game-situation training.'
  }
]

export default function MSSpringOverview() {
  return (
        ...
        <div className="text-center mb-12">
          ...
          >
            ...
            <p className="text-white/70 text-base max-w-3xl mx-auto leading-relaxed">
              Spring season development training. Designed specifically for middle school athletes building their basketball foundation.
            </p>
          </motion.div>
        </div>
