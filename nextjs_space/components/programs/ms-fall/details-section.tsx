...
const trainingDates = [
  { month: 'OCT', date: '5', day: 'SUN' },
  { month: 'OCT', date: '12', day: 'SUN' },
  { month: 'OCT', date: '19', day: 'SUN' },
  { month: 'OCT', date: '26', day: 'SUN' },
  { month: 'NOV', date: '2', day: 'SUN' },
  { month: 'NOV', date: '9', day: 'SUN' },
  { month: 'NOV', date: '16', day: 'SUN' },
]

export default function MSFallDetails() {
  return (
        ...
        <div className="text-center mb-12">
          ...
          >
            ...
            <p className="text-white/60 text-sm max-w-2xl mx-auto">
              Everything you need to know about the Middle School Skills Academy program
            </p>
          </motion.div>
        </div>
        ...
        >
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            ...
            <div className="text-center">
              ...
              <div className="text-white font-bold text-lg">7 Sundays</div>
            </div>
            <div className="text-center">
          ...
          <div className="lg:col-span-2">
            ...
            >
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="flex items-start gap-2 text-white/70">
                  <span className="text-tbf-gold mt-0.5">•</span>
                  <span>Program runs Oct 7 - Nov 13, 2025 (12 sessions)</span>
                </div>
                <div className="flex items-start gap-2 text-white/70">
                  <span className="text-tbf-gold mt-0.5">•</span>
