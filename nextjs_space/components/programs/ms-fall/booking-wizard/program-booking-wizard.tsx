      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl sm:text-5xl font-bold text-white mb-6 font-audiowide">
            REGISTER FOR <span className="text-[#C8B273]">MS FALL SKILLS</span>
          </h2>
          <p className="text-white/80 text-lg max-w-3xl mx-auto leading-relaxed">
            Complete your registration in 7 simple steps. Select your package, provide player information, and secure your spot in our middle school fall program.
          </p>
        </div>
