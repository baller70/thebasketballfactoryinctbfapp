...
export default function FutureStarsHero() {
  ...
  return (
    <section className="relative min-h-[85vh] flex items-center justify-center overflow-hidden bg-black pt-[320px]">
      ...
      <div className="absolute inset-0 z-0">
        <Image
          src="/future-stars-basketball-skills-development-hero.jpg"
          alt="Future Stars Skills Development"
          fill
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          <span className="text-black font-bold text-lg">100% FREE - NO COST!</span>
          <Gift className="w-5 h-5 text-black" />
        </motion.div>
        ...
        >
          <span className="!text-white bg-transparent block mb-2">Future Stars</span>
        ...
        >
          ...
          <span className="!text-white bg-transparent font-semibold">Ages 7-10 • 4 Weeks • Sundays</span>
          <Star className="w-5 h-5 text-[#C8B273]" />
        </motion.div>
        ...
        >
          Give your child the gift of basketball this fall! Our FREE Future Stars clinic teaches fundamental skills through fun games and activities. 
          Perfect for kids ages 7-10 who want to learn basketball basics, stay active, and make lasting friendships. 
          <span className="text-[#C8B273] font-bold"> Spaces are limited!</span>
        </motion.p>
