...
const faqs = [
  {
    ...
    answer: 'This program is designed specifically for middle school athletes in grades 3-8. We welcome players of all skill levels - whether you\'re just starting out, preparing for your first tryout, or looking to refine your skills for competitive play. Our expert coaches adapt the training to meet each athlete where they are and push them to reach their full potential.'
  },
  {
  ...
  },
  {
    ...
    answer: 'We offer two flexible payment options: 1) Full Program - Pay for all 15 sessions upfront (8 Sundays + 7 Mondays) for the best value and savings compared to drop-in pricing, or 2) Pay As You Go - Pay $35 per session for the flexibility to attend only the sessions that work for your schedule. Specific pricing details and savings are provided during the booking process. We believe in making quality basketball training accessible to all families in the Sparta community.'
  },
  {
    question: 'Who are your trainers and what are their qualifications?',
    answer: 'Our program is led by Kevin Houston ("Mr. Basic") and his team of experienced basketball trainers. Kevin has over 15 years of experience training youth athletes and has helped over 200 athletes in Sussex County reach their basketball goals. Our coaching staff includes former college players and coaches who understand the demands of high school basketball and what it takes to succeed at tryouts and throughout the season.'
  },
  {
    question: 'How are training sessions structured and what is the schedule?',
    answer: 'Each training session runs for 90 minutes at our Sparta facility (38 Station Rd). Sunday sessions run from 10:00 AM to 11:30 AM, and Monday sessions run from 6:30 PM to 8:00 PM. Sessions begin with a dynamic warm-up, followed by skill development drills focusing on shooting, ball handling, and defense. We then move into game-situation training where athletes apply what they\'ve learned in competitive scenarios. Each session ends with cool-down stretching. The program runs for 7 weeks from December 7, 2025 through February 10, 2026, with 15 total sessions (8 Sundays + 7 Mondays).'
  },
  {
...
export default function MSWinterFAQ() {
  ...
  return (
    <section id="faq-section" className="relative py-24 bg-gradient-to-b from-black via-gray-900 to-black">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          >
            ...
            <p className="text-white/80 text-lg max-w-3xl mx-auto leading-relaxed">
              Got questions? We've got answers. Here's everything parents need to know about our Middle School Winter Workouts program.
            </p>
          </motion.div>
        </div>
        ...
        <div className="space-y-4">
          {faqs.map((faq, index) => (
            ...
            >
              ...
              >
                <h3 className="text-lg font-bold text-white pr-4 uppercase" style={{ fontFamily: 'Russo One, sans-serif' }}>
                  {faq.question}
                </h3>
                <div className={`
        ...
        >
          <h3 className="text-2xl font-bold text-white mb-4 font-audiowide uppercase">
