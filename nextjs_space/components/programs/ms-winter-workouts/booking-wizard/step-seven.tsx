...
export default function StepSeven({ bookingData }: StepSevenProps) {
  useEffect(() => {
    ...
    if (!bookingData.bookingId) {
      alert('Booking ID not found. Please contact support.')
      return
    }
  ...
  const handleShareProgram = () => {
    if (navigator.share) {
      navigator.share({
        title: 'MS Winter Workouts - The Basketball Factory',
        text: 'I just registered for The Basketball Factory\'s MS Winter Workouts program!',
    ...
    <div className="space-y-8">
      ...
      <div className="text-center">
        ...
        <p className="text-white/80 text-lg max-w-2xl mx-auto">
          Congratulations! {bookingData.playerName} is officially registered for the MS Winter Workouts program. 
