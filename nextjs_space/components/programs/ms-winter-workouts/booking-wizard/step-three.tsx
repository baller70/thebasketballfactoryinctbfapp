...
const sundayTrackDates = [
  { date: '2025-12-07', day: 'Sunday', time: '10:00 AM - 11:30 AM', week: 'Week 1' },
  { date: '2026-01-04', day: 'Sunday', time: '10:00 AM - 11:30 AM', week: 'Week 2' },
  { date: '2026-01-11', day: 'Sunday', time: '10:00 AM - 11:30 AM', week: 'Week 3' },
  { date: '2026-01-18', day: 'Sunday', time: '10:00 AM - 11:30 AM', week: 'Week 4' },
  { date: '2026-01-25', day: 'Sunday', time: '10:00 AM - 11:30 AM', week: 'Week 5' },
  { date: '2026-02-01', day: 'Sunday', time: '10:00 AM - 11:30 AM', week: 'Week 6' },
  { date: '2026-02-08', day: 'Sunday', time: '10:00 AM - 11:30 AM', week: 'Week 7' },
  { date: '2026-02-10', day: 'Sunday', time: '10:00 AM - 11:30 AM', week: 'Week 7' },
]

const mondayTrackDates = [
  { date: '2026-01-05', day: 'Monday', time: '6:30 PM - 8:00 PM', week: 'Week 2' },
  { date: '2026-01-12', day: 'Monday', time: '6:30 PM - 8:00 PM', week: 'Week 3' },
  { date: '2026-01-19', day: 'Monday', time: '6:30 PM - 8:00 PM', week: 'Week 4' },
  { date: '2026-01-26', day: 'Monday', time: '6:30 PM - 8:00 PM', week: 'Week 5' },
  { date: '2026-02-02', day: 'Monday', time: '6:30 PM - 8:00 PM', week: 'Week 6' },
  { date: '2026-02-09', day: 'Monday', time: '6:30 PM - 8:00 PM', week: 'Week 7' },
  { date: '2026-02-10', day: 'Monday', time: '6:30 PM - 8:00 PM', week: 'Week 7' },
]
    ...
    <div className="space-y-8">
      <div className="text-center">
        ...
        <p className="!text-white bg-transparent/80 max-w-2xl mx-auto">
          {isFullProgram 
            ? 'Full program includes ALL 15 sessions (8 Sundays + 7 Mondays). Both Sunday Track (90 min) and Monday Track (90 min) sessions are included.'
      ...
      <div className="max-w-3xl mx-auto">
        {isFullProgram && (
          <div className="bg-[#C8B273]/10 border-2 border-[#C8B273] rounded-lg p-6 mb-8">
            <div className="flex items-start justify-between mb-4">
              <div>
                <h4 className="text-xl font-bold text-white font-audiowide mb-2 uppercase">Full Program - 15 Sessions</h4>
                <div className="space-y-2">
                  <div>
                    <p className="text-[#C8B273] font-semibold">Sunday Sessions (8 total)</p>
                    <p className="text-white/70 text-sm">10:00 AM - 11:30 AM (90 minutes)</p>
                  </div>
                  <div>
                    <p className="text-[#C8B273] font-semibold">Monday Sessions (7 total)</p>
                    <p className="text-white/70 text-sm">6:30 PM - 8:00 PM (90 minutes)</p>
                  </div>
                </div>
              </div>
        ...
        {((isFullProgram && selectedTrack) || !isFullProgram) && (
          <div className="space-y-4">
            <h4 className="!text-white bg-transparent font-bold text-center mb-4 font-audiowide uppercase">
