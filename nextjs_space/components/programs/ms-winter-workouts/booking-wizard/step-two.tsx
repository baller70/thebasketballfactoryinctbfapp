...
const packageNames = {
  'full-program': 'Full Program (8 Weeks)',
      ...
      <div className="max-w-2xl mx-auto">
            ...
            <div className="space-y-3">
              ...
              {isFullProgram && (
                <div className="flex justify-between text-green-400 font-semibold">
                  ...
                  <span>${(50 * pricingInfo.sessionCount) - pricingInfo.price}</span>
                </div>
              )}
        ...
        <div className="bg-[#C8B273]/10 border border-[#C8B273]/30 rounded-lg p-6 mb-6">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h5 className="!text-white bg-transparent font-bold text-lg font-audiowide uppercase">PROGRAM SCHEDULE</h5>
          </div>
        ...
        <div className="bg-black/50 border border-white/20 rounded-lg p-6 mb-6">
          ...
          <ul className="space-y-2 !text-white bg-transparent/80 text-sm">
            ...
            <li className="flex items-start gap-2">
              <Check className="w-4 h-4 text-[#C8B273] flex-shrink-0 mt-0.5" />
              <span>Comprehensive skill development curriculum</span>
            </li>
            <li className="flex items-start gap-2">
              <Check className="w-4 h-4 text-[#C8B273] flex-shrink-0 mt-0.5" />
              <span>Position-specific training & drills</span>
            </li>
            <li className="flex items-start gap-2">
              <Check className="w-4 h-4 text-[#C8B273] flex-shrink-0 mt-0.5" />
              <span>Strength & conditioning exercises</span>
            </li>
            <li className="flex items-start gap-2">
              <Check className="w-4 h-4 text-[#C8B273] flex-shrink-0 mt-0.5" />
              <span>Basketball IQ & game strategy sessions</span>
            </li>
            <li className="flex items-start gap-2">
              <Check className="w-4 h-4 text-[#C8B273] flex-shrink-0 mt-0.5" />
            ...
            <li className="flex items-start gap-2">
              <Check className="w-4 h-4 text-[#C8B273] flex-shrink-0 mt-0.5" />
              <span>Progress tracking & skill assessments</span>
            </li>
            {isFullProgram && (
              <li className="flex items-start gap-2">
                <Check className="w-4 h-4 text-[#C8B273] flex-shrink-0 mt-0.5" />
