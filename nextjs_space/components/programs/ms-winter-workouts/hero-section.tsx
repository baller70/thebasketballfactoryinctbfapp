  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-[320px] pb-32">
      ...
      <div className="absolute inset-0 z-0">
        <Image
          src="/middle-school-winter-basketball-workouts-2025.png"
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          {/* Main Title */}
          <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold !text-white bg-transparent mb-6 leading-tight font-russo-one uppercase">
            MIDDLE SCHOOL<br />
          ...
          <p className="text-xl sm:text-2xl !text-white bg-transparent/90 mb-4 max-w-3xl mx-auto font-medium">
            Develop Your Game During the Winter Basketball Season
          </p>
          
          <p className="text-lg !text-white bg-transparent/70 mb-12 max-w-2xl mx-auto leading-relaxed">
            Designed for middle school athletes. Build fundamental skills, boost confidence, and stay competitive throughout the winter season.
          </p>

          {/* Key Stats */}
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-3xl mx-auto mb-12">
            <div className="bg-black/50 backdrop-blur-sm border border-tbf-gold/30 rounded-lg p-6">
              <div className="text-3xl font-bold text-tbf-gold mb-2 font-russo-one">15</div>
            ...
            <div className="bg-black/50 backdrop-blur-sm border border-tbf-gold/30 rounded-lg p-6">
              <div className="text-3xl font-bold text-tbf-gold mb-2 font-russo-one">3-8</div>
