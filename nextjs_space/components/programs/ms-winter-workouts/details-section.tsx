...
const trainingDatesSunday = [
  { month: 'DEC', date: '7', day: 'SUN', fullDate: '2025-12-07' },
  { month: 'JAN', date: '4', day: 'SUN', fullDate: '2026-01-04' },
  { month: 'JAN', date: '11', day: 'SUN', fullDate: '2026-01-11' },
  { month: 'JAN', date: '18', day: 'SUN', fullDate: '2026-01-18' },
  { month: 'JAN', date: '25', day: 'SUN', fullDate: '2026-01-25' },
  { month: 'FEB', date: '1', day: 'SUN', fullDate: '2026-02-01' },
  { month: 'FEB', date: '8', day: 'SUN', fullDate: '2026-02-08' },
  { month: 'FEB', date: '10', day: 'SUN', fullDate: '2026-02-10' },
]

const trainingDatesMonday = [
  { month: 'JAN', date: '5', day: 'MON', fullDate: '2026-01-05' },
  { month: 'JAN', date: '12', day: 'MON', fullDate: '2026-01-12' },
  { month: 'JAN', date: '19', day: 'MON', fullDate: '2026-01-19' },
  { month: 'JAN', date: '26', day: 'MON', fullDate: '2026-01-26' },
  { month: 'FEB', date: '2', day: 'MON', fullDate: '2026-02-02' },
  { month: 'FEB', date: '9', day: 'MON', fullDate: '2026-02-09' },
  { month: 'FEB', date: '10', day: 'MON', fullDate: '2026-02-10' },
]
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          >
            ...
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-3 font-audiowide uppercase">
              PROGRAM <span className="text-tbf-gold">DETAILS</span>
            </h2>
            <p className="text-white/60 text-sm max-w-2xl mx-auto">
              Everything you need to know about the Middle School Winter Workouts program
            </p>
          </motion.div>
        </div>
        ...
        >
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div className="text-center">
              ...
              <div className="text-white font-bold text-lg">Grades 3-8</div>
            </div>
            <div className="text-center">
            ...
            <div className="text-center">
              ...
              <div className="text-white font-bold text-lg">15 Sessions</div>
            </div>
            <div className="text-center">
          ...
          <div className="lg:col-span-2">
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-xl font-bold text-white font-audiowide uppercase">WINTER 2025-2026 TRAINING DATES</h3>
              </div>
              ...
              <div className="mb-8">
                <div className="bg-tbf-gold/10 rounded-lg p-4 mb-4">
                  <div className="flex items-center justify-between">
                    <div>
                      <div className="text-tbf-gold text-xs font-bold uppercase mb-1">Sunday Track</div>
                      <div className="text-white font-bold text-lg">10:00 AM - 11:30 AM (90 Minutes)</div>
                    </div>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-4">
                  {trainingDatesSunday.map((date, index) => (
                    <motion.div
                      key={index}
              ...
              <div className="mb-6">
                <div className="bg-tbf-gold/10 rounded-lg p-4 mb-4">
                  <div className="flex items-center justify-between">
                    <div>
                      <div className="text-tbf-gold text-xs font-bold uppercase mb-1">Monday Track</div>
                      <div className="text-white font-bold text-lg">6:30 PM - 8:00 PM (90 Minutes)</div>
                    </div>
                    <Clock className="w-8 h-8 text-tbf-gold/40" />
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-4">
                  {trainingDatesMonday.map((date, index) => (
                    <motion.div
                      key={index}
                      initial={{ opacity: 0, scale: 0.9 }}
                      whileInView={{ opacity: 1, scale: 1 }}
          ...
          <div className="space-y-6">
            ...
            >
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <h3 className="text-lg font-bold text-white font-audiowide uppercase">Pricing</h3>
        ...
        >
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="text-xl font-bold text-white font-audiowide mb-1 uppercase">Training Location</h3>
