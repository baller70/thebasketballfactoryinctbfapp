...
export default function WinterProgramsHero() {
  return (
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <h1 className="text-5xl md:text-6xl font-black text-white mb-6 leading-tight font-russo-one">
              Winter Basketball<br />
              <span className="text-tbf-gold">Programs 2025-2026</span>
            </h1>
            
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              Expert-led training programs designed to support youth athletes during the competitive winter season. Stay sharp with skill development, conditioning, and game-situation training.
            </p>
          ...
          >
            <div className="relative h-[500px] rounded-2xl overflow-hidden shadow-2xl">
              <Image
                src="/winter-basketball-training-programs-2025.png"
                alt="Winter Basketball Training in Sparta NJ"
                fill
