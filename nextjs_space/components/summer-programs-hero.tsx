        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              Expert-led summer camps and training programs designed to keep youth athletes sharp during the off-season. Weekly camps, skill development, and competitive play for all ages.
            </p>
          ...
          >
            <div className="relative h-[500px] rounded-2xl overflow-hidden shadow-2xl">
              <Image
                ...
                alt="Summer Basketball Training in Sparta NJ"
                fill
