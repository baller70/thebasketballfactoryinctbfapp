    ...
    <section className="relative py-24 bg-gradient-to-b from-black via-gray-900 to-black overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-white font-semibold">Flexible Scheduling Available</p>
                    <p className="text-white/70 text-sm">Book sessions that fit your family's schedule</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-white font-semibold">Convenient Sparta Location</p>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Button
                  ...
                  size="lg"
                  variant="outline"
                  className="border-2 border-white text-white hover:bg-white hover:text-black font-bold text-lg px-8 py-6 rounded-none"
                >
                  CONTACT US
                </Button>
              </div>
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -right-6 bg-black border-2 border-tbf-gold rounded-lg p-6 shadow-2xl max-w-xs">
                <h4 className="text-white font-bold text-lg mb-4 font-audiowide uppercase">HAVE QUESTIONS?</h4>
                <div className="space-y-3">
                  <a href="tel:+19732408759" className="flex items-center gap-3 text-white/90 hover:text-tbf-gold transition-colors">
                    <Phone className="w-5 h-5 text-tbf-gold" />
                    <span className="text-sm">(973) 240-8759</span>
                  </a>
                  <a href="mailto:khouston@thebasketballfactorynj.com" className="flex items-center gap-3 text-white/90 hover:text-tbf-gold transition-colors">
        ...
        <div className="bg-black/40 border border-tbf-gold/20 rounded-lg p-8">
          <h3 className="text-2xl font-bold text-white mb-6 text-center font-audiowide uppercase">
            FREQUENTLY ASKED <span className="text-tbf-gold">QUESTIONS</span>
          </h3>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="text-center">
              <h4 className="text-white font-semibold mb-2 uppercase">What age groups do you train?</h4>
              <p className="text-white/70 text-sm">We work with young athletes ages 7-18, from beginners to advanced players.</p>
            </div>
            <div className="text-center">
              <h4 className="text-white font-semibold mb-2 uppercase">How long are sessions?</h4>
              <p className="text-white/70 text-sm">All private lessons are 1 hour long, focused entirely on your child's development.</p>
            </div>
            <div className="text-center">
              <h4 className="text-white font-semibold mb-2 uppercase">Do you offer payment plans?</h4>
              <p className="text-white/70 text-sm">Yes! We offer flexible payment options for our multi-session packages.</p>
            </div>
            <div className="text-center">
              <h4 className="text-white font-semibold mb-2 uppercase">What should my child bring?</h4>
              <p className="text-white/70 text-sm">Just basketball shoes, water bottle, and a willingness to learn and work hard!</p>
            </div>
            <div className="text-center">
              <h4 className="text-white font-semibold mb-2 uppercase">Can parents watch sessions?</h4>
              <p className="text-white/70 text-sm">Absolutely! Parents are welcome to observe their child's training sessions.</p>
            </div>
            <div className="text-center">
              <h4 className="text-white font-semibold mb-2 uppercase">How do I reschedule?</h4>
              <p className="text-white/70 text-sm">Contact us at least 24 hours in advance to reschedule at no charge.</p>
            </div>
          </div>
        </div>
