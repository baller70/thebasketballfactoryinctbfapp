      ...
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        <div className="bg-black/50 border border-tbf-gold/30 rounded-lg p-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h4 className="!text-white bg-transparent font-bold text-lg font-audiowide uppercase">TERMS AND CONDITIONS</h4>
          </div>

          <div className="bg-black rounded border border-white/20 p-6 max-h-96 overflow-y-auto space-y-4 !text-white bg-transparent/80 text-sm leading-relaxed">
            <div>
              <h5 className="font-bold !text-white bg-transparent mb-2">1. Payment Terms</h5>
            ...
            <div>
              <h5 className="font-bold !text-white bg-transparent mb-2">2. Scheduling & Attendance</h5>
            ...
            <div>
              <h5 className="font-bold !text-white bg-transparent mb-2">3. Cancellation Policy</h5>
            ...
            <div>
              <h5 className="font-bold !text-white bg-transparent mb-2">4. Rescheduling</h5>
            ...
            <div>
              <h5 className="font-bold !text-white bg-transparent mb-2">5. Package Expiration</h5>
            ...
            <div>
              <h5 className="font-bold !text-white bg-transparent mb-2">6. Facility Rules</h5>
            ...
            <div>
              <h5 className="font-bold !text-white bg-transparent mb-2">7. Equipment</h5>
            ...
            <div>
              <h5 className="font-bold !text-white bg-transparent mb-2">8. Parent/Guardian Observation</h5>
            ...
            <div>
              <h5 className="font-bold !text-white bg-transparent mb-2">9. Weather & Facility Closures</h5>
            ...
            <div>
              <h5 className="font-bold !text-white bg-transparent mb-2">10. Modification of Terms</h5>
          ...
          <div className="mt-6 flex items-start gap-3">
            ...
            />
            <label htmlFor="terms" className="!text-white bg-transparent/90 text-sm cursor-pointer">
        ...
        <div className="bg-black/50 border border-tbf-gold/30 rounded-lg p-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h4 className="!text-white bg-transparent font-bold text-lg font-audiowide uppercase">LIABILITY WAIVER</h4>
          </div>

          <div className="bg-black rounded border border-white/20 p-6 max-h-64 overflow-y-auto space-y-4 !text-white bg-transparent/80 text-sm leading-relaxed">
            <p>
            ...
            <p className="font-semibold !text-white bg-transparent mt-4">
          ...
          <div className="mt-6 flex items-start gap-3">
            <Checkbox
              ...
              className="mt-1 border-tbf-gold data-[state=checked]:bg-tbf-gold data-[state=checked]:text-black"
            />
            <label htmlFor="waiver" className="!text-white bg-transparent/90 text-sm cursor-pointer">
        ...
        <div className="bg-tbf-gold/10 border border-tbf-gold/30 rounded-lg p-6">
          <h4 className="!text-white bg-transparent font-bold mb-3 font-audiowide uppercase">PHOTO/VIDEO RELEASE (OPTIONAL)</h4>
          ...
          <div className="flex items-start gap-3">
            <Checkbox
              ...
              className="mt-1 border-tbf-gold data-[state=checked]:bg-tbf-gold data-[state=checked]:text-black"
            />
            <label htmlFor="photo" className="!text-white bg-transparent/90 text-sm cursor-pointer">
        ...
        <div className="bg-black/30 border border-white/20 rounded-lg p-4">
          <p className="!text-white bg-transparent/70 text-xs text-center">
