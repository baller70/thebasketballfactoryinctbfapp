...
export default function SpringProgramsHero() {
  return (
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <h1 className="text-5xl md:text-6xl font-black text-white mb-6 leading-tight font-russo-one">
              Spring Basketball<br />
              <span className="text-tbf-gold">Programs 2026</span>
            </h1>
            
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              Expert-led training programs designed to prepare youth athletes for AAU tournaments and summer competition. Choose the program that fits your child's age and goals.
            </p>
          ...
          >
            <div className="relative h-[500px] rounded-2xl overflow-hidden shadow-2xl">
              <Image
                ...
                alt="Spring Basketball Training in Sparta NJ"
                fill
