...
// Import the sync function from google-analytics.ts
const { syncGAData } = require('./nextjs_space/lib/google-analytics');
...
async function sendAlertEmail(errorMessage) {
  try {
    ...
    const { sendEmail } = require('./nextjs_space/lib/email');
